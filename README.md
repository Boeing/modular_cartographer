...
This repo holds a meta-package based on [cartographer-ros](https://google-cartographer-ros.readthedocs.io/en/latest/index.html)

`cartographer-ros` provides ROS integration for Cartographer.
Both `cartographer-ros` and `cartographer` have been forked and modified to suit Boeing factory needs. The fork of `cartographer` is available [here](https://github.com/Boeing/cartographer).
