...
struct Trajectory : public QObject
{
  ...
  public:
    Trajectory(std::unique_ptr<::rviz::BoolProperty> property, bool pose_markers_enabled);
...
class SubmapsDisplay : public ::rviz::MessageFilterDisplay<::cartographer_ros_msgs::SubmapList>
{
    Q_OBJECT
