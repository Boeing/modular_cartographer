...
class RosMapWritingPointsProcessor : public ::cartographer::io::PointsProcessor
{
  public:
    ...
    RosMapWritingPointsProcessor(
        ...
        ::cartographer::io::FileWriterFactory file_writer_factory, const std::string& filestem, PointsProcessor* next);
    ...
    static std::unique_ptr<RosMapWritingPointsProcessor>
        FromDictionary(::cartographer::io::FileWriterFactory file_writer_factory,
