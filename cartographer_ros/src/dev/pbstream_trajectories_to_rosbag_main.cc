                                                   ...
                                                   const cartographer::transform::proto::Rigid3d& parent_T_child)
{
    ...
    transform_stamped.transform =
        cartographer_ros::ToGeometryMsgTransform(::cartographer::transform::ToRigid3(parent_T_child));
...
int main(int argc, char* argv[])
{
    ...
    cartographer_ros::pbstream_trajectories_to_bag(FLAGS_input, FLAGS_output, FLAGS_parent_frame);
    return 0;
}
