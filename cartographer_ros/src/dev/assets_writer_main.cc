...
int main(int argc, char** argv)
{
    ...
    CHECK(!FLAGS_pose_graph_filename.empty()) << "-pose_graph_filename is missing.";
    ...
    ::cartographer_ros::AssetsWriter asset_writer(FLAGS_pose_graph_filename, bag_filenames, FLAGS_output_file_prefix);

    asset_writer.Run(FLAGS_configuration_directory, FLAGS_configuration_basename, FLAGS_urdf_filename,
