...
void CheckOdometryMessage(const nav_msgs::msg::Odometry::ConstSharedPtr message)
{
...
void CheckTfMessage(const tf2_msgs::msg::TFMessage::ConstSharedPtr message)
{
...
void Run(const std::string& bag_filename, const bool dump_timing)
{
    ...
    for (const auto& entry_pair : frame_id_to_properties)
    {
        ...
        if (frame_properties.data_type == rosidl_generator_traits::data_type<sensor_msgs::msg::Imu>() &&
